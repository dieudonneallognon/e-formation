                                                                                                    ...
                                                                                                    <td valign="top"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <p
                                                                                                                    style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#289CDC;'>
                                                                                                                    <span
                                                                                                                        class="font logo-text">{{ env('APP_NAME') }}</span>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </td>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="contentEditable"
                                                                                            ...
                                                                                            <p>
                                                                                                ...
                                                                                                <br>
                                                                                                <span
                                                                                                    style='color:#222222;'>{{ env('APP_NAME') }}</span>
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                ...
                                                                                <td align='center'>
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td align='center'
                                                                                                bgcolor='#5340d9'
                                                                                                style='background:#5340d9; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                                                <div
                                                                                                    class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable"
                                                                                                        align='center'>
